...
return (new CustomEvent(event_name,(function (){var obj26600 = {"detail":data};
return obj26600;
})()));
} else {
...
var f = (function (){var pred__26607 = cljs.core._EQ_;
var expr__26608 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__26607.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__26608))){
return ((function (pred__26607,expr__26608){
return (function (p1__26601_SHARP_){
return console.warn(p1__26601_SHARP_);
});
;})(pred__26607,expr__26608))
} else {
if(cljs.core.truth_(pred__26607.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__26608))){
return ((function (pred__26607,expr__26608){
return (function (p1__26602_SHARP_){
return console.debug(p1__26602_SHARP_);
});
;})(pred__26607,expr__26608))
} else {
if(cljs.core.truth_(pred__26607.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__26608))){
return ((function (pred__26607,expr__26608){
return (function (p1__26603_SHARP_){
return console.error(p1__26603_SHARP_);
});
;})(pred__26607,expr__26608))
} else {
return ((function (pred__26607,expr__26608){
return (function (p1__26604_SHARP_){
return console.log(p1__26604_SHARP_);
});
;})(pred__26607,expr__26608))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__26611){
...
var eval_fn = cljs.core.get.call(null,map__26612__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__26614_SHARP_);
});})(new_def))
);
...
return (function (p__26615){
var vec__26616 = p__26615;
var ky = cljs.core.nth.call(null,vec__26616,(0),null);
var v = cljs.core.nth.call(null,vec__26616,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1522701089411
